        ...
        try {
            ...
            Promise.all(this.jsonData.entity.map(async entity => {
                if (entity.tripUpdate) {
                    ...
                    if (!this.trips.get(tripId) || this.stop_times.get(tripId).length === 0) {
                        return;
                    }
                    ...
                    if (tripUpdate.trip.startTime) {
                        ...
                        tripStartTime = this.addDuration(serviceDay, this.parseGTFSDuration(this.stop_times.get(tripId)[0]['departure_time']));
                    }
